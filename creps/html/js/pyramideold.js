$(function() {
    ...
    var titrepyr = d3.select("svg").append("text")
     ...
     var textepyr = d3.select("svg").append("text")
        .text("La pyramide des âges présentée ici permet d'avoir un aperçu global et en même temps très préçis sur l'âge \n set le sexe des personnes listées à haut niveau dans la région pays de la Loire. Elle permet de prendre en compte une discipline particulière qui sera détaillée par le nombre de listés,leur âge moyen et la répartition féminine et masculine globale mais aussi pour chaque tranche d'âge. Par ce moyen intuitif nous pouvons faire passer un maximum d'informations majeures.")
        .attr("x",540)
        .attr("y",62)
        .attr("font-size",14)
        .attr("fill","#f8e82f");
